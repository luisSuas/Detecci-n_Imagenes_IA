...
# ========= Detector =========
try:
    from detector_problemas import ProblemDetector
    try:
...
def stt():
    ...
    try:
        ...
        if not raw or len(raw) < 800:
            # también devolvemos el sid para que el front lo ignore si no coincide
        ...
        # Limpia el buffer de esa sesión si nos lo indican
...
def stt_chunk():
    ...
    try:
        ...
        merged = None
        if sid:
            # Guarda parcial y genera unificado
